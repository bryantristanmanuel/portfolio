      ...
      <!--   -----------------About----------------- -->
            ...
            <div class="container">
                <div class="row">
                    <div class="about-col-1">
                        <img src="<?php echo base_url(); ?>/assets/images/about_pic.jpg">
                    </div>
        ...
        <div id="portfolio">
            <div class="container">
                ...
                <div class="work-list">
                    <div class="work">
                        <img src="<?php echo base_url(); ?>/assets/images/work1.JPG">
                        <div class="layer">
                    ...
                    <div class="work">
                        <img src="<?php echo base_url(); ?>/assets/images/work2.JPG">
                        <div class="layer">
                            <h3>Seamanjobsite.com</h3>
                            <p>Seaman Jobsite provides the latest job openings for seafarers worldwide. All maritime jobs are posted by licensed manning agencies and maritime companies.</p>
                            <a href="#"><i class="fa-solid fa-arrow-up-right-from-square"></i></a>
                    ...
                    <div class="work">
                        <img src="<?php echo base_url(); ?>/assets/images/work3.JPG">
                        <div class="layer">
                            <h3>Seamanjobsite.com</h3>
                            <p>Seaman Jobsite provides the latest job openings for seafarers worldwide. All maritime jobs are posted by licensed manning agencies and maritime companies.</p>
                            <a href="#"><i class="fa-solid fa-arrow-up-right-from-square"></i></a>
